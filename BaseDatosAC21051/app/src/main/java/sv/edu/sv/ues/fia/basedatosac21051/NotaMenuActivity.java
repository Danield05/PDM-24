...
public class NotaMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listView = findViewById(R.id.menuListNota);
        ...
        if (savedInstanceState != null) {
            ...
            if (selectedItem != -1) {
                listView.getChildAt(selectedItem).setBackgroundColor(Color.rgb(255, 128, 0));
            }
        }
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            if (position != 4) {
                ...
                try {
                    ...
                    Intent intent = new Intent(NotaMenuActivity.this, aClass);
