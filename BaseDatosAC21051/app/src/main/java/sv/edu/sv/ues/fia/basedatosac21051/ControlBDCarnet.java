...
public class ControlBDCarnet {
        ...
        private static class DatabaseHelper extends SQLiteOpenHelper {
            ...
            public String insertar(Alumno alumno){
                ...
                if(contador==-1 || contador==0) {
                    regInsertados= "Error al Insertar el registro, Registro               " +
            ...
            public String insertar(Materia materia){
                String regInsertados="Registro Insertado Nº= ";
                long contador=0; ContentValues mate = new ContentValues();
            ...
            public String actualizar(Materia materia){
                if (verificarIntegridad(materia, 6)) {
                    ...
                    return "Registro con codigo de materia " + materia.getCodmateria() + " no existe";
                }
            ...
            public String actualizar(Nota nota){
                if(verificarIntegridad(nota, 2)){
                    ...
                    db.update("nota", cv, "codmateria = ? " +
                            "AND carnet = ? AND ciclo = ?", id);
                    return "Registro Actualizado Correctamente";
                }else{
            ...
            public String eliminar(Nota nota){
                String regAfectados="filas afectadas= ";
                int contador=0; String where="carnet='"+nota.getCarnet()+"'";
        ...
        public Nota consultarNota(String carnet, String codmateria, String ciclo){
            ...
            Cursor cursor = db.query("nota", camposNota, "carnet = ? " +
                    "AND codmateria = ? AND ciclo = ?", id, null, null, null);
            if(cursor.moveToFirst()){
                Nota nota = new Nota();
        ...
        public String llenarBDCarnet(){
            ...
            final String[] VNcodmateria = {"MAT115","PRN115","IEC115","TSI115","IEC115","MAT115","PRN115"}; final String[] VNciclo = {"12016","12016","22016","22016","22016","12016","22016"};
            ...
            for(int i=0;i<4;i++){
                ...
                alumno.setMatganadas(0); insertar(alumno);
            }
            Materia materia = new Materia();
            for(int i=0;i<4;i++){
